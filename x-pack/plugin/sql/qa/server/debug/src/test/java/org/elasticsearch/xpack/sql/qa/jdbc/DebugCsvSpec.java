...
@TestLogging(value = "org.elasticsearch.xpack.sql:TRACE,org.elasticsearch.client.RestClient:ERROR", reason = "debug")
public class DebugCsvSpec extends SpecBaseIntegrationTestCase {
    ...
    public static List<Object[]> readScriptSpec() throws Exception {
        ...
        return readScriptSpec("/debug/debug.csv-spec", parser);
    }
