...
public class EsqlBaseParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements EsqlBaseParserVisitor<T> {
   ...
   * {@link #visitChildren} on {@code ctx}.</p>
   */
  @Override public T visitSearchQueryCommand(EsqlBaseParser.SearchQueryCommandContext ctx) { return visitChildren(ctx); }
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation returns the result of calling
   * {@link #visitChildren} on {@code ctx}.</p>
   */
  @Override public T visitSearchQueryDeclaration(EsqlBaseParser.SearchQueryDeclarationContext ctx) { return visitChildren(ctx); }
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation returns the result of calling
   ...
   * {@link #visitChildren} on {@code ctx}.</p>
   */
  @Override public T visitSearchScoreCommmand(EsqlBaseParser.SearchScoreCommmandContext ctx) { return visitChildren(ctx); }
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation returns the result of calling
